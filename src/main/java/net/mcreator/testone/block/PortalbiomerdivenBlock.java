...
public class PortalbiomerdivenBlock extends TestoneElements.ModElement {
	@ObjectHolder("testone:portalbiomerdiven")
	public static final Block block = null;
	public PortalbiomerdivenBlock(TestoneElements instance) {
		super(instance, 65);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("portalbiomerdiven");
		}
