...
public class SpongecitBlock extends TestoneElements.ModElement {
	@ObjectHolder("testone:spongecit")
	public static final Block block = null;
	public SpongecitBlock(TestoneElements instance) {
		super(instance, 81);
	}
