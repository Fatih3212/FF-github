...
public class DenemebiotoprakBlock extends TestoneElements.ModElement {
	@ObjectHolder("testone:denemebiotoprak")
	public static final Block block = null;
	public DenemebiotoprakBlock(TestoneElements instance) {
		super(instance, 9);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("denemebiotoprak");
		}
