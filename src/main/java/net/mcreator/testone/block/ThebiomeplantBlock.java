...
public class ThebiomeplantBlock extends TestoneElements.ModElement {
	@ObjectHolder("testone:thebiomeplant")
	public static final Block block = null;
	public ThebiomeplantBlock(TestoneElements instance) {
		super(instance, 26);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS, MaterialColor.GRASS).doesNotBlockMovement().sound(SoundType.GROUND)
					.hardnessAndResistance(0f, 0f).lightValue(0));
			setRegistryName("thebiomeplant");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(TheBiomeFriutEdibleItem.block, (int) (1)));
		}
