...
public class BiomebasamakBlock extends TestoneElements.ModElement {

	@ObjectHolder("testone:biomebasamak")
	public static final Block block = null;

	public BiomebasamakBlock(TestoneElements instance) {
		super(instance, 86);
