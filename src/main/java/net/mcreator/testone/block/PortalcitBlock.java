...
public class PortalcitBlock extends TestoneElements.ModElement {
	@ObjectHolder("testone:portalcit")
	public static final Block block = null;
	public PortalcitBlock(TestoneElements instance) {
		super(instance, 78);
	}
