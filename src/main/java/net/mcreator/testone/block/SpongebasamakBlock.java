...
public class SpongebasamakBlock extends TestoneElements.ModElement {
	@ObjectHolder("testone:spongebasamak")
	public static final Block block = null;
	public SpongebasamakBlock(TestoneElements instance) {
		super(instance, 80);
	}
