...
public class ThebiomeGrassBlock extends TestoneElements.ModElement {
	@ObjectHolder("testone:thebiomegrass")
	public static final Block block = null;
	public ThebiomeGrassBlock(TestoneElements instance) {
		super(instance, 23);
	}
