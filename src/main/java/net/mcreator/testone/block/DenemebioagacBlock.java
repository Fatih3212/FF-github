...
public class DenemebioagacBlock extends TestoneElements.ModElement {
	@ObjectHolder("testone:denemebioagac")
	public static final Block block = null;
	public DenemebioagacBlock(TestoneElements instance) {
		super(instance, 2);
	}
