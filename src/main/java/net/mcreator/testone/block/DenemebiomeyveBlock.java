...
import net.mcreator.testone.item.DenemebiomeyvesiItem;
...
public class DenemebiomeyveBlock extends TestoneElements.ModElement {
	@ObjectHolder("testone:denemebiomeyve")
	public static final Block block = null;
	public DenemebiomeyveBlock(TestoneElements instance) {
		super(instance, 5);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("denemebiomeyve");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(DenemebiomeyvesiItem.block, (int) (1)));
		}
