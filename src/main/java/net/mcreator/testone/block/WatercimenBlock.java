...
public class WatercimenBlock extends TestoneElements.ModElement {
	@ObjectHolder("testone:watercimen")
	public static final Block block = null;
	public WatercimenBlock(TestoneElements instance) {
		super(instance, 67);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(WaterdirtBlock.block, (int) (1)));
		}
	}
}
