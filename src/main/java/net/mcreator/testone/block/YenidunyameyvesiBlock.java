...
public class YenidunyameyvesiBlock extends TestoneElements.ModElement {
	@ObjectHolder("testone:yenidunyameyvesi")
	public static final Block block = null;
	public YenidunyameyvesiBlock(TestoneElements instance) {
		super(instance, 20);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("yenidunyameyvesi");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(YenidunyameyveItem.block, (int) (1)));
		}
