...
public class WatermerdivenBlock extends TestoneElements.ModElement {
	@ObjectHolder("testone:watermerdiven")
	public static final Block block = null;
	public WatermerdivenBlock(TestoneElements instance) {
		super(instance, 91);
	}
