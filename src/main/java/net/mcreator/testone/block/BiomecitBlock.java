...
public class BiomecitBlock extends TestoneElements.ModElement {
	@ObjectHolder("testone:biomecit")
	public static final Block block = null;
	public BiomecitBlock(TestoneElements instance) {
		super(instance, 87);
	}
