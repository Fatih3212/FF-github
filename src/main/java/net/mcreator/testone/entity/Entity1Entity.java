...
public class Entity1Entity extends TestoneElements.ModElement {

	public static EntityType entity = null;

	public Entity1Entity(TestoneElements instance) {
		super(instance, 44);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.9f, 1.4f)).build("entity1")
						.setRegistryName("entity1");

		elements.entities.add(() -> entity);

		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -16777216, new Item.Properties().group(ModesyalariItemGroup.tab)).setRegistryName("entity1"));
		...
		RenderingRegistry.registerEntityRenderingHandler(CustomEntity.class, renderManager -> {
			return new MobRenderer(renderManager, new CowModel(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("testone:textures/ntity1.png");
				}
			};
		});
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(TheBiomeFriutEdibleItem.block, (int) (1)));
		}
