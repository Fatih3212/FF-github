...
public class GhastbossStructure extends TestoneElements.ModElement {
	public GhastbossStructure(TestoneElements instance) {
		super(instance, 97);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("testone", "ghastboss"));
						if (template == null)
							return false;
