...
package net.mcreator.testone.world.dimension;
...
import net.mcreator.testone.item.TheBetweenWorldItem;
import net.mcreator.testone.block.YenidunyablokBlock;
import net.mcreator.testone.block.ThebetweenDiamondOreBlockBlock;
...
public class TheBetweenWorldDimension extends TestoneElements.ModElement {
	@ObjectHolder("testone:thebetweenworld")
	public static final ModDimension dimension = null;
	@ObjectHolder("testone:thebetweenworld_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public TheBetweenWorldDimension(TestoneElements instance) {
		super(instance, 17);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("thebetweenworld"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("testone:thebetweenworld")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("testone:thebetweenworld"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("testone:thebetweenworld"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("testone:deneme")),};
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new CustomPortalBlock());
		elements.items.add(() -> new TheBetweenWorldItem().setRegistryName("thebetweenworld"));
	}
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("thebetweenworld_portal");
		}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, Direction p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.func_196900_a(this.world.getBlockState(blockpos)) || !(this.world.getBlockState(blockpos.down())
							.getBlock() == ThebetweenDiamondOreBlockBlock.block.getDefaultState().getBlock())) {
						break;
					}
				}
				BlockPos framePos = p_180120_1_.offset(p_180120_2_, i);
				return (this.world.getBlockState(framePos).getBlock() == ThebetweenDiamondOreBlockBlock.block.getDefaultState().getBlock()) ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (!(this.world.getBlockState(framePos).getBlock() == ThebetweenDiamondOreBlockBlock.block.getDefaultState()
									.getBlock())) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					...
					if (!(this.world.getBlockState(framePos).getBlock() == ThebetweenDiamondOreBlockBlock.block.getDefaultState().getBlock())) {
						this.height = 0;
						break;
					}
				}
					...
					for (int i8 = 1; i8 < 3; ++i8) {
						for (int i9 = -1; i9 < 3; ++i9) {
							...
							this.world.setBlockState(blockpos$mutableblockpos,
									flag
											? ThebetweenDiamondOreBlockBlock.block.getDefaultState().getBlock().getDefaultState()
											: Blocks.AIR.getDefaultState());
						}
					}
				}
			...
			for (int k7 = -1; k7 < 3; ++k7) {
				for (int j8 = -1; j8 < 4; ++j8) {
					if (k7 == -1 || k7 == 2 || j8 == -1 || j8 == 3) {
						...
						this.world.setBlockState(blockpos$mutableblockpos,
								ThebetweenDiamondOreBlockBlock.block.getDefaultState().getBlock().getDefaultState(), 3);
					}
				}
			}
		...
		public ChunkProviderModded(IWorld world, BiomeProvider provider) {
			super(world, provider, new OverworldGenSettings() {
				public BlockState getDefaultBlock() {
					return YenidunyablokBlock.block.getDefaultState();
				}
		...
		public BiomeProviderCustom(World world) {
			...
			for (Biome biome : this.biomes) {
				biome.addCarver(GenerationStage.Carving.AIR, Biome.createCarver(new CaveWorldCarver(ProbabilityConfig::deserialize, 256) {
					{
						carvableBlocks = ImmutableSet.of(YenidunyablokBlock.block.getDefaultState().getBlock(),
