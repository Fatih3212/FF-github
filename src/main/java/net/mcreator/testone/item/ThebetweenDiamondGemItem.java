...
public class ThebetweenDiamondGemItem extends TestoneElements.ModElement {
	@ObjectHolder("testone:thebetweendiamondgem")
	public static final Item block = null;
	public ThebetweenDiamondGemItem(TestoneElements instance) {
		super(instance, 12);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("thebetweendiamondgem");
		}
